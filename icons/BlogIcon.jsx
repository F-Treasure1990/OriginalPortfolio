  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={d} height={d} viewBox={`0 0 ${d + 8} ${d + 8}`}>
      <g id="Group_349" data-name="Group 349" transform="translate(-1306.25 -492.75)">
        <path id="Path_5" data-name="Path 5" d="M55.35,5.783V1.821A1.321,1.321,0,0,0,54.029.5H40.821A1.321,1.321,0,0,0,39.5,1.821V20.312a1.321,1.321,0,0,0,1.321,1.321h9.258" transform="translate(1268 493.5)" fill="none" stroke={c} stroke-miterlimit="10" stroke-width="2.5" />
        <path
          id="Path_6"
          data-name="Path 6"
