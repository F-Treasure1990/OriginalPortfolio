...
export const ToolBelt_OptionImgContainer = styled.div`
  min-width: 40px;
  height: 40px;
...
export const ToolBelt_OptionTitle = styled(Text)`
  font-size: clamp(0.88rem, 0.77rem + 0.53vw, 1rem);
...
export const ToolBelt_OptionRightSideContainer = styled.div`
  display: flex;
...
export const ToolBelt_OptionConfidenceBar = styled.div`
  display: flex;
  height: 4px;
  border-radius: 8px;
  background-color: ${({ theme }) => theme?.palette?.secondary};
